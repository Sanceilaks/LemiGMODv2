...
public:
	...
	/*8*/	virtual void*   GetViewport() = 0;
	/*9*/	virtual void*   GetViewportAnimationController() = 0;
	/*10*/	virtual void	ProcessInput(bool bActive) = 0;
	/*11*/	virtual bool	ShouldDrawDetailObjects() = 0;				// Will always return 1
	/*12*/	virtual bool	ShouldDrawEntity(CBaseEntity* pEnt) = 0;		// Will always return 1
	/*13*/	virtual bool	ShouldDrawLocalPlayer(CBaseEntity* pPlayer) = 0;
	...
	/*17*/	virtual int		KeyInput(int down, int keynum, const char* pszCurrentBinding) = 0;
	/*18*/	virtual void	StartMessageMode(int iMessageModeType) = 0;
	/*19*/	virtual void*   GetMessagePanel() = 0;
	...
	/*30*/	virtual void	ActivateInGameVGuiContext(void* pPanel) = 0;
	...
	/*34*/	virtual void	ComputeVguiResConditions(void* pkvConditions) = 0;
};