...
public:
	...
	/*0*/virtual void			DrawBrushModel(CBaseEntity* baseentity, model_t* model, const Vector& origin, const QAngle& angles, bool bUnused) = 0;
	...
	/*26*/virtual void*		GetLightAtPoint(Vector& pos) = 0;		//return ColorVec
